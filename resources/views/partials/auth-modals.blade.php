    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="loginModalLabel">Sign in to GoGlow</h5>
                        ...
                        <div class="form-group col-md-12 mb-4">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="signup-terms">
                                    I agree to the <a href="{{ url('/terms_condition') }}" target="_blank">Terms</a> and <a href="{{ url('/privacy_policy') }}" target="_blank">Privacy Policy</a>
                                </label>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
